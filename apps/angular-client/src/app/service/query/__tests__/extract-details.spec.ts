import type { ProjectFile, ClassTemporaryDetail, MethodDetail, PropertyDetail, ConstructorMethodDetail, MethodsUsedDetail, ParameterDetail, Details } from "@doci/types";
